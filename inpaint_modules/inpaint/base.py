...
from inpaint_modules.utils.textblock_mask import extract_ballon_mask
from inpaint_modules.utils.imgproc_utils import enlarge_window
...
import torch
from inpaint_modules.utils.imgproc_utils import resize_keepasp
...
class LamaLarge(LamaInpainterMPE):
    ...
    def _load_model(self):
        ...
        self.model = load_lama_mpe(r'pretrain/lama_large_512px.ckpt', device='cpu', use_mpe=False, large_arch=True)
